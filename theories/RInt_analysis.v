...
Proof.
  ...
  destruct (ex_RInt_ub f (a - d1 / 2) (a + d1 / 2)) as [Mf HMf].
    ...
    rewrite Rabs_left.
    apply Rminus_lt_0 ; field_simplify.
    by apply is_pos_div_2.
    apply Ropp_lt_cancel ; field_simplify.
    by apply is_pos_div_2.
    eexists ; apply CIf.
    rewrite /ball /= /AbsRing_ball /= /abs /minus /plus /opp /=.
    field_simplify (a + d1 / 2 + - a)%R.
  ...
  apply Rminus_lt_0 ; field_simplify ; by apply is_pos_div_2.
  ...
  apply Rmin_case.
  apply Rlt_le, Rminus_lt_0 ; field_simplify ; by apply is_pos_div_2.
